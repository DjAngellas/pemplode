...
chmod +x start.sh
Dependency Installation Failed: Manual installation may be required:
...
File Not Found: Verify the PFX file path exists and is accessible.
...
└── extract_pem.py    # Python utility for PEM extraction
